...
To run each method on its own, simply execute the corresponding file. Only the recomposition and nonlinear regression methods are used in final analysis, which takes place in power\_meter.py
